...
In order to use TidyScreen, users can access the <a href="https://alfredoq.github.io/TidyScreen_v2_docs/" target="_blank" rel="noopener">documentation</a> describing the project and specific working examples.
