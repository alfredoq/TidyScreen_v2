...
class DockingAnalysis:
    ...
    ### Compute fingerprints using MMPBSA on target folder
        ...
        prmtop_file, crd_file, tleap_vs_cristal_reference_dict,mmpbsa_decomp_csv_output = docking_analysis_utils.compute_fingerprints(output_path,complex_pdb_file,receptor_filename,solvent,min_steps)
