...
class DockingAnalysis:
    ...
    def compute_fingerprints_for_docked_pose(self,assay_id,results_pose_id,clean_files=1,solvent="implicit",min_steps=5000):
        ...
        prmtop_file, crd_file = docking_analysis_utils.compute_fingerprints(output_path,complex_pdb_file,receptor_filename,solvent,min_steps)
        ## Compute ProLIFfingerprints for minimized pose
        docking_analysis_utils.compute_prolif_fps_for_docked_pose(prmtop_file,crd_file)
