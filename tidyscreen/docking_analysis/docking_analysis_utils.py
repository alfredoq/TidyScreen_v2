...
def compute_fingerprints(output_path,main_fingerprints_folder,complex_pdb_file,receptor_filename,solvent,min_steps,iteration,ligname):
    ...
    md_utils.apply_ante_MMPBSA(output_path,ligname)
